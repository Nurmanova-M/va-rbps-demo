      ...
      try {
        ...
        const proxyFetchOptions = {
          ...
          headers: {
            ...
            'X-App-Proxy': 'QeUZLGz2jrTQWjkkF466ri3--QMKGU3a',
            'X-App-Key': secretKey ?? '',
          },
        ...
        // Use document.baseURI to resolve relative URL in sandboxed environments
        const proxyUrl = new URL('/api-proxy', document.baseURI).href;
